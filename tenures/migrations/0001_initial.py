# Generated by Django 2.2.4 on 2019-09-14 19:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activated_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('has_opted_in', models.BooleanField(default=True, help_text='Indicates whether the user has opted to join the watched tenure when it eventually goes live')),
